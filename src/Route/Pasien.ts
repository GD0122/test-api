...
routerPas.get('/pasien',_VerifyToken,_validation_admin,_getPasien)
routerPas.get('/search/:name',_VerifyToken,)
routerPas.put('/edit/:id',_VerifyToken,_editPasien)
routerPas.delete('/delete_pas/:id',_VerifyToken,_deletePasien)
routerPas.get('/search/:names',_VerifyToken,_SearchPasien)
routerPas.get('/detail/:id',_VerifyToken,_getPasienById)
